...
export function appHarness(saved,overrides={}){
  ...
  const sandbox={
    projectSession:{current:null},...books,...media,...motion,...art,...storyMath,...terrain,...cinemaMath,LineSegments2,LineSegmentsGeometry,LineMaterial,...atmosphere,...video,paintGround:canvas=>canvas,THREE:{...THREE,WebGLRenderer:Renderer},OrbitControls,
