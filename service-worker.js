...
const CACHE='mountain-animator-shell-v13';
const SHELL=['./story-video.mjs?v=13','./video-media.mjs?v=13','./','./index.html','./styles.css?v=9','./controls.css?v=13','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./bootstrap.mjs?v=13','./project-manager.mjs?v=13','./project-store.mjs?v=13','./workspace-db.mjs?v=13','./install-app.mjs?v=13','./panel-sections.mjs?v=13','./peak-dialog.mjs?v=9','./app.js?v=13','./travel-book.mjs?v=13','./narrative-media.mjs?v=13','./studio-art.mjs?v=12','./camera-sequence.mjs?v=13','./gpx-story.mjs?v=13','./route-motion.mjs?v=7','./atmosphere.mjs?v=7','./terrain-data.mjs?v=7','./video-export.mjs?v=7'];
