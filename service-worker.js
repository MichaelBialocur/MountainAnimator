...
const CACHE='mountain-animator-shell-v12';
const SHELL=['./','./index.html','./styles.css?v=9','./controls.css?v=12','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./bootstrap.mjs?v=12','./project-manager.mjs?v=12','./project-store.mjs?v=12','./workspace-db.mjs?v=12','./install-app.mjs?v=12','./panel-sections.mjs?v=12','./peak-dialog.mjs?v=9','./app.js?v=12','./travel-book.mjs?v=12','./narrative-media.mjs?v=12','./studio-art.mjs?v=12','./camera-sequence.mjs?v=12','./gpx-story.mjs?v=11','./route-motion.mjs?v=7','./atmosphere.mjs?v=7','./terrain-data.mjs?v=7','./video-export.mjs?v=7'];
